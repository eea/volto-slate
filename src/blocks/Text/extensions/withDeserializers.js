...
/**
 * This extension just replaces the `<h1>` tag deserializer with the one for
 * `<h2>` tags. The rest of the default deserializers inherited from the
 * `SlateEditor` component are good already.
