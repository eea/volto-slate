...
const FootnoteButton = () => {
  ...
  console.log('footnote', footnote, editor.selection);

  if (isFootnote && footnote !== footnoteRef.current) {
  ...
  console.log('ref', editor.pluginToolbarRef.current);

  return (
    <>
      {footnoteRef.current && editor.pluginToolbarRef.current && (
        <Portal node={editor.pluginToolbarRef.current}>
          <PluginToolbar />
        </Portal>
      )}
      {/* <PluginSidebarPortal> */}
      ...
      {/*   </Button.Group> */}
      {/* </PluginSidebarPortal> */}
      {/* <PluginSidebar selected={showEditForm()}> */}
      {/*   <InlineForm */}
      ...
      <ToolbarButton
        active={isFootnote}
        onMouseDown={() => {
          editor.setShowPluginToolbar(true);
